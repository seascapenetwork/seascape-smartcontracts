...
/// @title AnniversarySwapParams is nft params encoder/decoder, signature verifyer
/// @author Nejc Schneider
contract AnniversarySwapParams {
    ...
    function paramsAreValid (uint256 _offerId, bytes memory _encodedData,
      ...
      (uint256 generation) = decodeParams(_encodedData);

      bytes32 hash = this.encodeParams(_offerId, generation);
    ...
    {
        (uint256 generation) = abi
            .decode(_encodedData, (uint256));
