...
contract("Nft Swap", async accounts => {
    ...
    it("9.1 should create offer id5 with offered SampleNft token", async() => {
      // parameters for createOffer
      let offerTokensAmount = 1;
      let requestedTokensAmount = 1;
      let bounty = web3.utils.toWei("0", "ether");
    ...
    it("9.2 should cancel offer id5 with unsupported SampleNft address", async() => {
    ...
    it("9.3 shouldnt create offer with unsupported requested SampleNft address", async() => {
      // parameters for createOffer
      let offerTokensAmount = 1;
      let requestedTokensAmount = 1;
      ...
      let offeredTokensArray = [                            // this array must contain sample data for empty slots
        // structure: [nftId, nftAddress]
        [sellerSampleNftIdCount, nft.address],
        ["0", "0x0000000000000000000000000000000000000000"],
        ["0", "0x0000000000000000000000000000000000000000"],
        ["0", "0x0000000000000000000000000000000000000000"],
        ["0", "0x0000000000000000000000000000000000000000"],
    ...
    it("9.4 shouldnt create offer with unsupported offered SampleNft address", async() => {
      // parameters for createOffer
      let offerTokensAmount = 1;
      let requestedTokensAmount = 1;
    ...
    it("9.5 should create offer id6 with offered SampleNft token", async() => {
      // parameters for createOffer
      let offerTokensAmount = 1;
      let requestedTokensAmount = 1;
      let bounty = web3.utils.toWei("10", "ether");
     ...
     it("9.6 should accept offer id6 with sampleNft token", async() => {
       let offerId = offersAmount;
